...
# 업데이트 확인용 버전
st.sidebar.info("✅ v10.1 - 연간 PDF 에디션 (3월 31일 해결)")
    ...
    for m in range(3, 13):
        ...
        for w_idx, week in enumerate(cal):
            ...
            if not m_rows.empty:
                ...
                if col_name in m_rows.columns:
                    aft_h = int(m_rows.iloc[0][col_name])
